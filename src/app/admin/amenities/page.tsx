...
export default async function AmenitiesPage(){
  ...
  return (<div className="space-y-6"><div className="flex items-center justify-between"><div><h1 className="font-display text-2xl font-light">Amenities</h1><p className="text-sm text-muted-foreground">{data?.length||0} amenities</p></div><button className="h-9 px-4 bg-brand-foreground text-brand-background text-xs tracking-widest">+ NEW</button></div>
