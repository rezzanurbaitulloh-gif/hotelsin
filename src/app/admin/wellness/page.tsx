...
export default async function WellnessAdminPage(){
  ...
  return (<div className="space-y-6"><div className="flex items-center justify-between"><div><h1 className="font-display text-2xl font-light">Wellness</h1><p className="text-sm text-muted-foreground">{data?.length||0} services • price & duration</p></div><a href="/admin/wellness/new" className="h-9 px-4 bg-brand-foreground text-brand-background inline-flex items-center text-brand-background text-xs tracking-widest">+ NEW SERVICE</a></div>
