...
export default async function JournalCMSPage(){
  ...
  return (<div className="space-y-6"><div className="flex items-center justify-between"><div><h1 className="font-display text-2xl font-light">Journal CMS</h1><p className="text-sm text-muted-foreground">{data?.length||0} posts • DRAFT/PUBLISHED/ARCHIVED</p></div><button className="h-9 px-4 bg-brand-foreground text-brand-background text-xs tracking-widest">+ NEW POST</button></div>
