export default function Page() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <p className="text-muted-foreground max-w-xl leading-relaxed mb-8">Calendar and occupancy map.</p>
      ...
      <p className="mt-8 text-xs text-muted-foreground">Route: <code className="bg-muted px-2 py-1 rounded">admin/availability</code> — rendering OK (zero-404 guarantee)</p>
    </div>
  )
}
