...
export default async function DinePage(){
  ...
  if(!data?.length) return <div className="container mx-auto px-6 py-24 text-center"><p className="text-muted-foreground">Belum ada restoran — admin tambah di /admin/dining</p></div>
