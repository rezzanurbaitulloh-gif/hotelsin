...
export default async function ExperiencesPage(){
  ...
  if(!data?.length) return <div className="container mx-auto px-6 py-24 text-center text-muted-foreground">Belum ada pengalaman — admin di /admin/experiences</div>
